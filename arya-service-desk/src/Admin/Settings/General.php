...
class General extends AbstractPage
{
    ...
    public function settings()
    {
        ...
        register_setting( 'arya_service_desk_general', 'arya_service_desk_general', $args );
    }
    ...
    public function render()
    {
        ...
        <div class="wrap">
            ...
            <h1 class="wp-heading-inline"><?php esc_html_e( 'General Settings', 'arya-service-desk' ); ?></h1>

            <form action="<?php echo esc_url( admin_url( 'options.php' ) ); ?>" method="post">

                <?php settings_fields( 'arya_service_desk_general' ); ?>
    ...
    public function help()
    {
        ...
        $tab = [
            'id'       => 'id-help',
            'title'    => esc_html__( 'Help!', 'arya-service-desk' ),
            'priority' => 10,
        ...
        $sidebar = '<p><strong>' . esc_html__( 'For more information:', 'arya-service-desk' ) . '</strong></p>' .
